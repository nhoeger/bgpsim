...
##pipenv run python -m bgpsecsim generate --trials "$number_of_trials" figure_two caida-data/20221101.as-rel.txt outputs/figure_two_"$number_of_trials"trials | tee figure_two_"$number_of_trials".txt
...
#pipenv run python -m bgpsecsim generate --trials "$number_of_trials" figure_roles_4 caida-data/20221101.as-rel.txt outputs/figure_roles_4_"$number_of_trials"trials | tee figure_roles_4_"$number_of_trials".txt
